...
def live_session_create(body: LiveSessionCreateRequest) -> LiveSessionResponse:
    store = _live_store()
...
def live_session_get(session_id: str) -> LiveSessionResponse:
    store = _live_store()
    return get_live_session(session_id, store)


@router.post("/{session_id}/icd", response_model=LiveSessionResponse)
def live_session_icd(session_id: str, body: LiveIcdRequest) -> LiveSessionResponse:
    store = _live_store()
...
def live_session_cpt_detect(session_id: str, body: LiveCptDetectRequest) -> LiveSessionResponse:
    store = _live_store()
...
def live_session_sentence(session_id: str, body: LiveTranscriptSentenceRequest) -> LiveSessionResponse:
    store = _live_store()
    return on_sentence_fed(session_id, body.sentence, store)


@router.post("/{session_id}/cpt/start", response_model=LiveSessionResponse)
def live_session_cpt_start(session_id: str, body: LiveCptDetectRequest) -> LiveSessionResponse:
    store = _live_store()
    return on_cpt_start(session_id, body.cpt_code, store)


@router.post("/{session_id}/cpt/end", response_model=LiveSessionResponse)
def live_session_cpt_end(session_id: str, body: LiveCptEndRequest) -> LiveSessionResponse:
    store = _live_store()
...
def live_session_cpt_pause(session_id: str, body: LiveCptDurationRequest) -> LiveSessionResponse:
    store = _live_store()
...
def live_session_cpt_resume(session_id: str, body: LiveCptDetectRequest) -> LiveSessionResponse:
    store = _live_store()
    return on_cpt_resume(session_id, body.cpt_code, store)


@router.post("/{session_id}/modifier", response_model=LiveSessionResponse)
def live_session_modifier(session_id: str, body: LiveModifierRequest) -> LiveSessionResponse:
    store = _live_store()
...
def live_session_end(session_id: str) -> LiveSessionResponse:
    store = _live_store()
